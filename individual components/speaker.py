...
korobeiniki_tempo = 150
korobeiniki = [
("E4",4), ("B3",2), ("C4",2), ("D4",2), ("E4",1), ("D4",1), ("C4",2), ("B3",2),
("A3",3), (0,1), ("A3",2), ("C4",2), ("E4",4), ("D4",2), ("C4",2),
("B3",6), ("C4",2), ("D4"4), ("E4",4),
("C4",4), ("A3",3), (0,1) ("A3",8),

(0,2), ("D4",4), ("F4",2), ("A4",4), ("G4",2), ("F4",2),
("E4",6), ("C4",2), ("E4",2), ("F4",1), ("E4",1), ("D4",2), ("C4",2),
("B3",3), (0,1), ("B3",2), ("C4",2), ("D4",4), ("E4",4), 
("C4",4), ("A3",3), (0,1), ("A3",4),(0,4),
...
("E3",8), ("C3",8), ("D3",8), ("B2",8),
("C3",8), ("A2",8), ("G#2",8), ("B2",8),
("E3",8), ("C3",8), ("D3",8), ("B2",8),
("C3",4), ("E3",4), ("A3",8), ("G#3",7), (0,0)
]
    ...
    while True:
        ...
        if state == States.init:
            ...
            if globals.game_play == True:
                song = korobeiniki
                index = 0
                tempo = 60000 / (1.5 * korobeiniki_tempo)
                timer = 0
        ...
        time.sleep(globals.speaker_period / 1000)
#end def tick
